...
export default function Edit() {
    ...
    const { notify, API_BASE_URL, CATEGORY_URL, fetchCategory, category } = useContext(MainContext)
    ...
    const submitHandler = (e) => {
        ...
        formdata.append("image_name", e.target.category_img.files[0] ?? null)
                    ...
                    <form onSubmit={submitHandler}>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className=' col-span-2' >
                                ...
                                <img className='w-24' src={API_BASE_URL + "/images/category/" + category.image_name} alt="current image" />
                            </div>
